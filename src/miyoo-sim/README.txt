...
1. INTRODUCTION
  ...
  WizSIM is a port on Wiz of the cvs version 0.90 beta 4 of SamCoupe.

  Thanks to Danzel and Jeff Chen for their virtual keyboard,
  and to all WizSDK developpers.
...
4. LOADING SAM DISK FILES
  ...
  or .td0 file extension) on your Wiz memory stick in the 'disk' directory.

  Then, while inside WizSIM emulator, just press SELECT to enter in 
...
5. LOADING KEY MAPPING FILES
  ...
  For given games, the default keyboard mapping between Wiz Keys and SAM keys,
  is not suitable, and the game can't be played on WizSIM.
...
6. COMPILATION
  ...
  It has been developped under Linux using gcc with WizSDK. 
