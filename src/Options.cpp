...
void Options::SetDefaults (bool fForce_/*=true*/)
{
    ...
    Options::s_Options.speed_limiter = 60;
    Options::s_Options.view_fps = 0;
    Options::s_Options.render_mode = 0;
    Options::s_Options.psp_joystick_cursor = 0;
    Options::s_Options.psp_cpu_clock = GP2X_EMU_CLOCK;
    ...
    gp2xPowerSetClockFrequency(Options::s_Options.psp_cpu_clock);
# if 0
